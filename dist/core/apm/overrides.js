...
const RINKEBY_UNLISTED_AGENT_V6 = '0x05087eD2aD442e252CF6c6c648f26b7298a17A88'; // This function is used to override how an app version should be loaded based on the base contract
// address (codeAddress).
...
function shouldOverrideAppWithLatestVersion(repoAddress, codeAddress) {
  if ( // Unlisted Agent with ERC-1155 hotfix
  // May be published as Agent v6 in the future
  (0, _utils.addressesEqual)(repoAddress, MAINNET_AGENT_REPO) && (0, _utils.addressesEqual)(codeAddress, MAINNET_UNLISTED_AGENT_V6) || (0, _utils.addressesEqual)(repoAddress, RINKEBY_AGENT_REPO) && (0, _utils.addressesEqual)(codeAddress, RINKEBY_UNLISTED_AGENT_V6)) {
    return true;
  }
